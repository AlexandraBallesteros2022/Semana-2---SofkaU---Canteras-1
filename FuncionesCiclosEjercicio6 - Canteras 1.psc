SubProceso anadirContactos()
	Definir tel1, tel2, tel3, nom1, nom2, nom3, orga1, orga2, orga3 Como Caracter;
	Definir cont, cont2 Como Logico;
	cont <- Verdadero; cont2 <- Verdadero;
	Escribir "CONTACTO 1";
	Escribir "Nombre:";
	Leer nom1;
...
SubProceso buscarContacto()
	Definir  nomC, tel1, tel2, tel3, nom1, nom2, nom3, orga1, orga2, orga3 Como Caracter;
	nomC <- ""; nom1 <- ""; nom2 <- ""; nom3 <- "";
	orga1 <- ""; orga2 <- ""; orga3 <- "";
	tel1 <- ""; tel2 <- ""; tel3 <- "";
...
SubProceso salir <- salirP()
	Definir salir Como Logico;
FinSubProceso

Proceso FuncionesCiclosEjercicio6
