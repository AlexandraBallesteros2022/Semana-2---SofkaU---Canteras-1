SubProceso cantVehiculo <- ingresarVeh(cantVeh)
	Definir cantVehiculo Como Entero;
	cantVehiculo <- cantVeh;
FinSubProceso
...
Proceso FuncionesCiclosEjercicio7
	Definir marca, nom, tel, repet, placa, placaC Como Caracter;
	Definir opcion, cantVeh, cantVehiculo Como Entero;
	Definir salir Como Logico;
	cantVeh <- 0;
	salir <- Verdadero;
	...
	Segun opcion Hacer
		...
		1:
			cantVehiculo <- ingresarVeh(cantVeh);
