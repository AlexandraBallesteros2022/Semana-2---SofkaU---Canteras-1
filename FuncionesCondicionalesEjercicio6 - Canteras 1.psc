SubProceso caracMotocicleta <- ingresarMoto(marca, cilindraje, observacion)
	Definir caracMotocicleta Como Logico;
	caracMotocicleta <- verdadero;
FinSubProceso

SubProceso caracMotocicleta <- salidaMoto(marca, cilindraje, observacion)
	Definir caracMotocicleta Como Logico;
	caracMotocicleta <- verdadero;
FinSubProceso

SubProceso cantRepuestos <- arreglosMecanico(marca, nomRepuestos, nomRepuestos2)
	Definir cantRepuestos Como Entero;
	cantRepuestos <- 0;
FinSubProceso

Proceso FuncionesCondicionalesEjercicio6
	...
	Segun opcion Hacer
		...
		1: 
			marca <- ""; cilindraje <- ""; observacion <- "";
			caracMotocicleta <-  ingresarMoto(marca, cilindraje, observacion);
		...
		2: 
			marca <- ""; cilindraje <- ""; observacion <- "";
			caracMotocicleta <-  salidaMoto(marca, cilindraje, observacion);
		...
		3:
			marca <- ""; nomRepuestos <- ""; nomRepuestos2 <- "";
			cantRepuestos <- arreglosMecanico(marca, nomRepuestos, nomRepuestos2);
			Escribir "Ingrese la marca de la motocicleta:";
			Leer marca;
