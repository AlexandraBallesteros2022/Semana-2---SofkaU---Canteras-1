SubProceso cantIngreso()
	Definir ingreso, sum, cantidad Como Entero;
	cantidad <- 2500000;
	Escribir "Indique el valor que desea ingresar a su cuenta:";
	Leer ingreso;
	...
	SiNo
		...
		Escribir "El valor ingresado es: ", ingreso, " y la cantidad total de su cuenta suma ", sum;
	FinSi
FinSubProceso

SubProceso realizaRetiro()
	Definir cantidad, retiro Como Entero;
	cantidad <- 2600000;
